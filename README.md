# Project-006 : Website deployed on AWS cloud, using Cloudfront, S3, Route 53 and Cloudformation.

Ln-A06-Deployment-of-web-page-using-AWS-S3-Cloudfront-Route53-Cloudformation
...
|----upload-script.sh       # To be delivered by DevOps staff (Script to upload website content to S3)
|----static-web
        |----index.html     # Given to the DevOps staff (HTML file)
        |----cat0.jpg       # Given to the DevOps staff (image file)
        |----cat1.jpg       # Given to the DevOps staff (image file)
        |----cat2.jpg       # Given to the DevOps staff (image file)
```
